...
with open(filename, 'r') as f:
    ...
    u_exact = [float(line.split()[3]) for line in lines]
...
uei = scipy.interpolate.griddata((x, y), u_exact, (xi, yi), method='linear')
...
ax.plot_surface(xi, yi, ui, rstride=1, cstride=1, cmap=cm.coolwarm, linewidth=0, alpha=0.75 )
